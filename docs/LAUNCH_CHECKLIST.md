...
3. [ ] Payments
       ...
       [ ] `WHOP_API_KEY` in Vercel (the app finds both plans by price; no plan ids needed)
       [ ] Whop webhook → `https://cuenta-clara-six.vercel.app/api/webhooks/whop`, secret in Vercel as `WHOP_WEBHOOK_SECRET`
